...
\begin{document}
	...
	\begin{result}
		...
		\begin{itemize}
			\item If there exists $a \in \Sigma$ such that $f_1 \neq a, \forall f\in \mathcal{F}$, then $G = (\Lang{\Forb}, \delta_1)$ is strongly connected.
			\item Same result if there exists $a \in \Sigma$ such that $f_{|f|-1} \neq a, \forall f\in \mathcal{F}$.
		\end{itemize}
	\end{result}
	\noindent
